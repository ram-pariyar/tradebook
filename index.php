    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#" style="padding: 2px;"><img class="img-responsive" alt="Brand"
                        src="img/logo.jpeg" style="width: 80px;margin: 0px;">
                </a>
            </div>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                <a href="description.php?ID=NEW-1&category=new">
                    <div class="book-block">
                        ...
                        <img class="book block-center img-responsive" src="img/new/1.jpg" alt="">
                        <hr>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                <a href="description.php?ID=NEW-2&category=new">
                    <div class="book-block">
                        ...
                        <hr>
                        Lower Secondary Level Sceince<br>
                        Rs 48 &nbsp
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                <a href="description.php?ID=NEW-3&category=new">
                    <div class="book-block">
                        ...
                        <hr>
                        Senior English Project <br>
                        Rs 80 &nbsp
                        <span style="text-decoration:line-through;color:#828282;"> 400 </span>
